...
if(isset($_POST['submit']))
{
    ...
    else
    {
        ...
        $sql = "INSERT INTO posts (title,author,category,datetime,image,post)";
        $sql .= "VALUES (:title,:author,:category,:datetime,:image,:post)";
...
<head>
    ...
    <title>Blog Cms site | Add Post</title>
</head>
                    ...
                    <div class="card bg-secondary text-light">
                        ...
                        <div class="card-body bg-dark">
                            <div class="form-group">
                                ...
                                <input type="text" name="postTitle" id="title" placeholder="Add Post title" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="postDesc" rows="8" cols="80"></textarea>
                            </div>
                            <div class="row">
